package by.homework.regauthapp.view;
...
import by.homework.regauthapp.service.servicefactory.ServiceFactory;
...
public class Main {
    ...
    private static UserService selectStorage() {
        ...
        switch (choice) {
            case 1:
                return ServiceFactory.getServiceFactory().getUserService();
            case 2:
                return ServiceFactory.getServiceFactory().getFileUserService();
            case 3:
                return ServiceFactory.getServiceFactory().getSQLUserService();
            case 4:
                System.exit(0);
            default:
                try {
